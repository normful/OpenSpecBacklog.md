...
export const SchemaYamlSchema = z.object({
	...
	// Optional apply phase config (for schema-aware apply instructions)
...
export const ChangeMetadataSchema = z.object({
	...
	created: z.string().regex(/^\d{4}-\d{2}-\d{2}$/, { message: "created must be YYYY-MM-DD format" }),
...
// Simple completion tracking via filesystem
